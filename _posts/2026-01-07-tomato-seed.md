---
layout: post
title: Finding Meaning in the Core Microbiome
categories:
  - Carolina Lobato
feature_image:
---
...
The seed endosphere represents a particularly informative system for this question as it is spatially constrained, developmentally regulated, and tightly linked to plant fitness. Our analysis revealed that only a small fraction of the total microbial diversity is ubiquitous in tomato seeds, however accounting for a disproportionately large fraction of total community abundance. These observations contribute to the notion that inheritance may play a more significant role in plant ecology than previously appreciated. 

**Keywords:** Core microbiome • Seed microbiome • Microbial inheritance • Ecological filtering • Host–microbe interactions • Tomato 


Read the research **[here](https://doi.org/10.1128/msystems.01441-25)**
